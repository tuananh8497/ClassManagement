        ...
        <div id="content" class="container">
            ...
            <form class="form shadow-sm">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control shadow-sm" id="class-account" placeholder="Input account of class you want to edit . . .">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="class-name" class="col-sm-2 col-form-label">Class Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control shadow-sm" id="class-name" placeholder="Input name of the class account you want to change . . .">
                  </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-1">
                      <button type="submit" class="btn btn-info shadow-sm"><a href="#">Edit class name</a></button>
                    </div>
                </div>
            </form>
