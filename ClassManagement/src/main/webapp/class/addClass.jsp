...
<body>
	...
	<div class="wrapper">
		...
		<div id="content" class="container">
			...
			<form class="form shadow-sm" method="post" action= "<%= request.getContextPath()%>/addClass">
				<div class="form-group row">
					<label for="class-account" class="col-sm-2 col-form-label">Class
						Code</label>
					<div class="col-sm-10">
						<input type="text" class="form-control shadow-sm"
							id="class-account" name="classCode" placeholder="Input class code ....">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					<div class="col-sm-1">
						<button type="submit" class="btn btn-info shadow-sm" >Create class</button>
					</div>
				</div>
			</form>
