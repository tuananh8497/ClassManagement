	...
	<div class="wrapper">
		...
		<div id="content" class="container">
			...
			<form class="form shadow-sm" method="post"
				action="<%=request.getContextPath()%>/createTimetable">
				...
				<div class="form-group row">
					<label for="subject-name" class="col-sm-2 col-form-label">Subject Name</label>
					<div class="col-sm-10">
						<select class="custom-select" id="inputGroupSelect01" name="subjectId">
							<c:forEach items="${listSubject }" var="subject1">
								<option value="${subject1.subjectId }"> ${subject1.subjectName } </option>
							</c:forEach>
						</select>
					</div>
				</div>
				<div class="form-group row">
					<label for="class-account" class="col-sm-2 col-form-label">Priority</label>
					<div class="col-sm-10">
				...
				<div class="form-group row">
					<label for="class-account" class="col-sm-2 col-form-label">Duration</label>
					<div class="col-sm-10">
						<input type="text" class="form-control shadow-sm " 
