        ...
        <div id="content" class="container form">
            ...
            <form role="form" method="post" action="<%= request.getContextPath()%>/createStudent">
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" placeholder="Enter account . . ." name="account">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" placeholder="Enter citizen ID . . ." name="citizenId">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label border-bottom">Bank Account</label>
                    <div class="col-lg-9">
                        <input class="form-control" type="text" placeholder="Enter bank account . . ." name="bankAccount">
                    </div>
                </div>
